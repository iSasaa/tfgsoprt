            ...
            try {
                ...
                if (Array.isArray(issues)) {
                    const messages = (issues as ZodIssue[]).map((issue) => {
                        ...
                        if (issue.code === "too_small" && issue.path?.includes("password")) return "Password min. 6 chars.";
            ...
            <div className="flex-1 flex items-center justify-center px-6">
                ...
                >
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-xl px-8 py-8 relative overflow-hidden">
                        ...
                        <div className="mb-6">
                            <h1 className="text-2xl font-extrabold tracking-tight text-slate-800 mb-1">Create your account</h1>
                            <p className="text-sm text-slate-400">Start building smarter training sessions.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <button
                                ...
                                className="group w-full py-3.5 bg-orange-500 text-white rounded-xl font-bold text-sm uppercase tracking-wider shadow-lg shadow-orange-500/20 hover:bg-orange-600 hover:shadow-xl transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3"
                            >
                        ...
                        <div className="mt-6 pt-5 border-t border-slate-100 text-center">
                            <p className="text-sm text-slate-400">
                                ...
                                <Link href="/login" className="text-blue-600 font-bold hover:underline underline-offset-2">Sign in</Link>
                            </p>
                        </div>
                    </div>
                </motion.div>
