    ...
    return (
        <div className="relative" ref={containerRef}>
            <button
                ...
                className="flex items-center gap-1 font-semibold text-slate-300 hover:text-white transition-colors uppercase"
            >
                ...
                <div className="absolute top-full left-0 mt-2 w-40 rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 z-50">
                    {sports.map((s) => (
                        <button
                            ...
                            className={`block w-full px-4 py-2 text-left text-sm hover:bg-slate-100 uppercase ${sport === s ? "font-bold text-orange-500" : "text-slate-700"
                                }`}
                        >
                            {s}
                        </button>
